...
// * @描述 会话界面的消息列表适配器
// */
//public class ChatSessionAdapter extends LQRAdapterForRecyclerView<Message> {
//
...
//
//
//    public ChatSessionAdapter(Context context, List<Message> data, ChatAtPresenter presenter) {
//        super(context, data);
//        mContext = context;
//        mData = data;
...
////                ((ChatActivity) mContext).jumpToActivity(intent);
//            }
//        });
//    }
//
...
//            ImageMessage imageMessage = (ImageMessage) msgContent;
//            BubbleImageView bivPic = helper.getView(R.id.bivPic);
//            boolean isSend = item.getMessageDirection() == SEND ? true : false;
//            if (isSend) {
//                Message.SentStatus sentStatus = item.getSentStatus();
//                if (sentStatus == Message.SentStatus.SENDING) {
...
//            boolean isSendForPreMsg = preMsg.getMessageDirection() == SEND ? true : false;
...
//        boolean isSend = msg.getMessageDirection() == SEND ? true : false;
//
