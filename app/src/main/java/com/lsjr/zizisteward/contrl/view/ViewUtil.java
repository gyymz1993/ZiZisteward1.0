...
public class ViewUtil {
    ...
    public static int dp2px(float dp){
        return (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, BaseApplication.getApplication().getResources().getDisplayMetrics());
    }

    public static float px2dp(float px){
        return px/ UIUtils.getResources().getDisplayMetrics().density;
    }

    public static float sp2px(float sp){
        return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, sp, BaseApplication.getApplication().getResources().getDisplayMetrics());
    }

    public static float px2sp(float px){
        return px/ UIUtils.getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static void requestInputMethodIfShow(final EditText view){
        final InputMethodManager imm= (InputMethodManager) BaseApplication.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE);
        if(imm.isActive()) {
            view.requestFocus();
