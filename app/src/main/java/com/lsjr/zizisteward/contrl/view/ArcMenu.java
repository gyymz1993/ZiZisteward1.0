...
public class ArcMenu extends FrameLayout {
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            L_.e("defaultChildSize  :"+defaultChildSize);
    ...
    public void applySizeChange(float persents){
        setArcLayoutSize((int) (ViewUtil.dp2px(100)* persents));
        setMenuSize((int) (ViewUtil.dp2px(60)* persents));
