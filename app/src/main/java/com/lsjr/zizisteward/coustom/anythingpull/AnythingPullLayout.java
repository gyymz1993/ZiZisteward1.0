package com.lsjr.zizisteward.coustom.anythingpull;
...
import com.lsjr.zizisteward.coustom.anythingpull.adapter.Adapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.LoadDstAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.LoadLayerAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.LoadPullAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.RefreshDstAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.RefreshLayerAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.RefreshPullAdapter;
import com.lsjr.zizisteward.coustom.anythingpull.adapter.ViewAdapter;
...
public class AnythingPullLayout extends ViewGroup {
    ...
    private boolean checkRefresh(int dy) {
        return !(Math.abs(dy) < touchSlop && (mStatus == REFRESH_ING || mStatus == REFRESH_RESULT));
    }
    ...
    private boolean checkLoad(int dy) {
        return !(Math.abs(dy) < touchSlop && (mStatus == LOAD_ING || mStatus == LOAD_RESULT));
    }
